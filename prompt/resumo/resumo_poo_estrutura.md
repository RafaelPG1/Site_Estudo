Você receberá um RESUMO de conteúdo de POO.
...
NÃO criar novos campos além dos definidos abaixo
...
professor → nome do professor que ministrou a aula. Os únicos valores válidos são: "Bruno", "Wagner" ou "Raul". Extrair do resumo ou do contexto fornecido.
...
═══════════════════ EXEMPLO MÍNIMO ═══════════════════
Entrada:
"Aula sobre variáveis — Professor: Bruno. Variável é um espaço na memória para guardar dados. Tipos: inteiro, texto, booleano."
Saída esperada:
aulas: [
{
aula: "Aula — Variáveis",
