...
- Use pegadinhas conceituais sutis (não pegadinhas de português ou ambiguidade proposital mal escrita).
...
- Distribuir as respostas corretas de forma equilibrada entre A, B, C e D (evitar concentrar em uma letra).
...
- [ ] Limites respeitados: máx. 1 chip por afirmativa, máx. 2 chips por feedback, nenhum chip em `options`?
