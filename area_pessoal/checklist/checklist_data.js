  ...
  categorias: [
    {
      ...
      icone: '📐',
      itens: [
        { id: '2026_1_poo_f1', texto: '[POO 2026.1] Classes e Objetos (teoria + exemplos)' },
        { id: '2026_1_poo_f2', texto: '[POO 2026.1] Herança vs Polimorfismo (comparação prática)' },
        { id: '2026_1_poo_f3', texto: '[POO 2026.1] Encapsulamento + Abstração (exercícios guiados)' },
        { id: '2026_1_poo_f4', texto: '[POO 2026.1] Interfaces e Classes Abstratas (quando usar)' },
      ]
    },
    {
      nome: 'Exercícios POO',
      icone: '💻',
      itens: [
        { id: '2026_1_poo_e1', texto: '[POO 2026.1] Lista 1 - Classes simples (Java)' },
        { id: '2026_1_poo_e2', texto: '[POO 2026.1] Lista 2 - Herança aplicada (Java)' },
        { id: '2026_1_poo_e3', texto: '[POO 2026.1] Lista 3 - Collections + Generics' },
        { id: '2026_1_poo_e4', texto: '[POO 2026.1] Projeto Final (Sistema orientado a objetos)' },
      ]
    },
    {
      nome: 'Avaliações POO',
      icone: '📋',
      itens: [
        { id: '2026_1_poo_a1', texto: '[POO 2026.1] Revisão Prova 1 (conteúdo inicial)' },
        { id: '2026_1_poo_a2', texto: '[POO 2026.1] Revisão Prova 2 (conteúdo avançado)' },
        { id: '2026_1_poo_a3', texto: '[POO 2026.1] Simulado Final (tempo real)' },
      ]
    }
  ]
}
