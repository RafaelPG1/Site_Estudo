...
const SECTIONS = [
  ...
  { id: 'sessions',  label: 'Sessões',    icon: iconSessions()  },
];
...
async function _navegarPara(secao) {
  ...
  switch (secao) {
    ...
    case 'sessions':  await _renderSessions();  break;
    default:
...
export async function _getUsuarios(force = false) {
...
export function _modalConfirmar(titulo, subtitulo, labelConfirmar, onConfirm, anchorEl = null) {
...
export function _toast(msg, erro = false) {
