  ...
  questoes: [
    {
      ...
      options: ["ALTER TABLE", "INSERT INTO", "CREATE TABLE", "DROP TABLE"],
      answer: 2,
      feedback: "==ddl==CREATE TABLE== é o comando DDL para criação de tabelas."
    },
    {
      question: "O que o comando ==danger==DROP TABLE== faz?",
      options: [
        "Remove apenas os dados da tabela",
        "Altera a estrutura da tabela",
        "Remove a estrutura e os dados permanentemente",
        "Cria uma cópia da tabela"
      ],
      answer: 2,
      feedback: "==danger==DROP TABLE== remove tanto a estrutura quanto os dados. Diferente de ==dml==DELETE==, que remove apenas os dados."
    },
    {
      question: "O que é uma ==key==PRIMARY KEY==?",
      options: [
        "Um campo que pode se repetir",
        "Um campo que identifica unicamente cada registro",
        "Um campo que referencia outra tabela",
        "Um campo opcional"
      ],
      answer: 1,
      feedback: "A ==key==PRIMARY KEY== identifica unicamente cada registro e não pode ser nula nem repetida."
    },
    {
      question: "Para que serve a ==key==FOREIGN KEY==?",
      options: [
        "Criar índices de busca",
        "Definir o tipo de dado de uma coluna",
        "Criar relacionamento entre tabelas",
        "Remover dados duplicados"
      ],
      answer: 2,
      feedback: "A ==key==FOREIGN KEY== cria um relacionamento entre tabelas, garantindo **integridade referencial**."
    }
  ],
