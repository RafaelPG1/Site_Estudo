/* ============================================================
   NEXUS STUDY — quiz/disciplinas/2026/disciplinas_init.js

   Responsabilidades (roda em todos os *.html de disciplina):
     1. Lê ?sem= da URL (fallback: '2026.2')
     2. Injeta ?sem= na URL visível via replaceState
     3. Propaga ?sem= nos links de saída (ava_template / quiz_template)
     4. Propaga ?sem= no back-btn (id="back-btn")
