/* ═══════════════════════════════════════════════════
   ...
   games/conteudo/flashcards/cards_data.js
═══════════════════════════════════════════════════ */
...
const _CARDS_POR_SEMESTRE = {
  ...
  '2026.2': {
    ...
    redes: [
      // Adicione cards de Redes aqui quando disponível
    ],

    poo: [
      // Adicione cards de POO aqui quando disponível
    ],
...
/**
 * Retorna o mapa { disciplina: cards[] } para o semestre informado.
 * Se o semestre não existir, retorna objeto vazio (nenhum card).
 */
